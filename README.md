...
<h3>ENTER YOUR NAME</h3> DHANUSH M
...
```
## OUTPUT:
<img width="1021" height="617" alt="image" src="https://github.com/user-attachments/assets/4df5d38d-7766-4afc-aff3-ca8c68446da0" />
<img width="1002" height="638" alt="image" src="https://github.com/user-attachments/assets/5e2ab1e9-856e-4b85-beab-5813d658475a" />


## RESULT:
Unifmem2 gives better GPU execution performance because its GPU matrix-addition time is lower:
0.062957 s < 0.077849 s
It also transfers less data from Host → Device (128 MB vs 165.25 MB) and has fewer CPU page faults. Thus, the second Unified Memory implementation makes more efficient use of memory and provides better GPU performance.
